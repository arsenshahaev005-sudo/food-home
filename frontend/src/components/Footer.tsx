...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-[#4b2f23] to-[#CD845B] text-white">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link 
                  href="/" 
                  className="text-[#fcf8f3] hover:text-white transition-colors duration-200"
                >
                  Главная
                </Link>
              </li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-[#e8dccf]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@food-home.ru" className="text-[#fcf8f3] hover:text-white transition-colors duration-200">
                  info@food-home.ru
                </a>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+74951234567" className="text-[#fcf8f3] hover:text-white transition-colors duration-200">
                  +7 (495) 123-45-67
                </a>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-[#e8dccf] mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <address className="text-[#fcf8f3] not-italic">
        ...
        <div className="mt-12 pt-8 border-t border-[#e8dccf]">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-[#e8dccf] text-sm">
              © {currentYear} Food Home. Все права защищены.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link 
                href="/legal/privacy" 
                className="text-[#e8dccf] hover:text-white text-sm transition-colors duration-200"
              >
